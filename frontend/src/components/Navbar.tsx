  ...
  return (
    <header className="flex items-center justify-between px-8 py-6 lg:px-20 max-w-[1440px] mx-auto w-full z-20 relative bg-background-dark/80 backdrop-blur-md border-b border-primary/20">
      ...
      <nav className="hidden lg:flex items-center gap-10">
        <Link href="/" className="text-sm font-bold hover:text-primary transition-colors uppercase tracking-[0.15em] text-primary border-b-2 border-primary pb-1">Arsenal</Link>
        <Link href="#" className="text-sm font-bold hover:text-primary transition-colors text-gray-400 uppercase tracking-[0.15em]">Specs</Link>
